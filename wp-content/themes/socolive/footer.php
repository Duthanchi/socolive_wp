  ...
  <footer class="footer-wrapper">
    <div class="inner clearfix">
      <div class="logo-footer"><img
          src="<?php echo get_template_directory_uri(); ?>/assets/images/logo-footer.png" alt="Soco Live">
        <a href="https://www.facebook.com/socolive.official/" target="_blank"><svg class="logo-footer-icon"
            xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" aria-hidden="true" role="img"
            width="1em" height="1em" preserveAspectRatio="xMidYMid meet" viewBox="0 0 24 24">
            <path fill="#545454" fill-rule="evenodd"
          ...
          </svg> </a><a href="https://www.youtube.com/c/SocoliveOfficial" target="_blank"><svg class="logo-footer-icon"
            xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" aria-hidden="true" role="img"
            width="1.13em" height="1em" preserveAspectRatio="xMidYMid meet" viewBox="0 0 576 512">
            <path fill="#545454"
          ...
          </svg> </a><a href="https://twitter.com/socolivevn" target="_blank"><svg class="logo-footer-icon"
            xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" aria-hidden="true" role="img"
          ...
          </svg> </a><a href="https://www.instagram.com/socolive" target="_blank"><svg class="logo-footer-icon"
            xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" aria-hidden="true" role="img"
            width="1em" height="1em" preserveAspectRatio="xMidYMid meet" viewBox="0 0 24 24">
            <path fill="#545454" fill-rule="evenodd"
              ...
              clip-rule="evenodd"></path>
          </svg> </a><a href="https://www.gapo.vn/page/1788666161522353880" target="_blank"><svg
            class="logo-footer-icon" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
          ...
          </svg> </a><a href="https://www.tiktok.com/@socolivetructiepbongda" target="_blank"><svg
            class="logo-footer-icon" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
            aria-hidden="true" role="img" width="1em" height="1em" preserveAspectRatio="xMidYMid meet"
            viewBox="0 0 256 256">
            <path fill="#545454"
          ...
          </svg> </a><a href="https://t.me/socolive" target="_blank"><svg class="logo-footer-icon"
            xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" aria-hidden="true" role="img"
            width="1em" height="1em" preserveAspectRatio="xMidYMid meet" viewBox="0 0 24 24">
            <path fill="#545454" fill-rule="evenodd"
              ...
              clip-rule="evenodd"></path>
          </svg> </a><a href="https://soundcloud.com/socolive" target="_blank"><svg class="logo-footer-icon"
            xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" aria-hidden="true" role="img"
            width="1em" height="1em" preserveAspectRatio="xMidYMid meet" viewBox="0 0 24 24">
            <path fill="#545454"
      ...
      <div class="guide">
        <div><a href="https://socolive10.tv/pages/vi/service.html" target="_blank">Điều khoản dịch vụ</a></div>
        <div><a href="https://socolive10.tv/pages/vi/secrecy.html" target="_blank">Chính sách bảo mật</a></div>
        <div><a href="https://socolive10.tv/pages/vi/promise.html" target="_blank">Lời hứa từ Socolive</a></div>
        <div><a href="https://socolive10.tv/pages/vi/about.html" target="_blank">Về chúng tôi</a></div>
        <div><a href="https://socolive10.tv/pages/vi/contact.html" target="_blank">Phương thức liên hệ</a></div>
        <div><a href="https://socolive10.tv/pages/vi/disclaimer.html" target="_blank">Tuyên bố miễn trừ trách nhiệm</a>
        </div>
      </div>
      <div class="desc">
        <p>Copyright © 2020 <span class="footer-url">socolive</span>, All rights reserved.</p>
      </div>
    </div>
  </footer>  
