    ...
    [16], {
            ...
            n.r(e),
                function(t, e) {
                    ...
                    ! function(t, o) {
                        ...
                        function e(t, e) {
                            this.settings = i(o, e || {}), this.images = t || document.querySelectorAll(this.settings.selector), this.observer = null, this.init()
                        }
                        ...
                        var o = {
                            ...
                            i = function t() {
                                var e = {},
                                    ...
                                    o = 0,
                                    i = arguments.length;
                                for ("[object Boolean]" === Object.prototype.toString.call(arguments[0]) && (n = arguments[0], o++); o < i; o++) ! function(o) {
                                    for (var i in o) Object.prototype.hasOwnProperty.call(o, i) && (n && "[object Object]" === Object.prototype.toString.call(o[i]) ? e[i] = t(!0, e[i], o[i]) : e[i] = o[i])
                                }(arguments[o]);
                                return e
                            };
                        if (e.prototype = {
        ...
        159: function(t, e, n) {
            ...
            var o = n(31),
                ...
                v = n(23),
                g = n(2);
            n(37), d.default.handleIsHadUserLogin() && v.default.init(), $(s()(c.a.mark((function t() {
                        ...
                        case 0:
                            T = function(t) {
                                if (t) {
                                    ...
                                    })), $(".index-wrapper .marquee-container").show(), $(".index-wrapper .marquee-container .marquee-box").html(e);
                                ...
                                })), $(".video-list .room-list").html(e), $(".hot .all-content").html(n), f.default.loadImg("live"), l.storeData.indexLoad = 1, 0 === $(".index-wrapper .hot .all-content").children().length && $(".index-wrapper .hot .none-data").show()
                            }, x = function() {
                                m.default.hotAnchor().then((function(t) {
                                    if (t && t.anchors) {
                                        ...
                                        if (e.length > 0) {
                                            ...
                                            })), $(".anchor-swiper-container .swiper-wrapper").html(n), f.default.loadImg("avatar"), e.length <= 8 ? ($(".swiper-button-prev.anchor-prev").hide(), $(".swiper-button-next.anchor-next").hide()) : a.init()
                                        } else $(".anchor").hide()
                                    }
                                }))
                            }, C = function() {
                                                ...
                                                if (b && 0 != b.length)
                                                    for (var a = 0; a < b.length; a++)
                                                        if (t.scheduleId == b[a].scheduleId) {
                                                            t.reservationStatus = 1, b.splice(a, 1);
                                                            break
                                ...
                                r = (v = t)[0], T(t.scroll), I(r), r && 0 != r.length && ($(".inLiveRoom").click((function() {
                                    var t = $(".video-inner .room-list .active").closest("li").attr("data-roomnum");
                                    console.log(f.default.roomUrl(t))
                                    window.location.href = f.default.roomUrl(t)
                                })), $(".goRoom").click((function() {
                                    var t = $(".video-inner .room-list .active").closest("li").attr("data-roomnum");
                                    window.location.href = f.default.roomUrl(t)
                                })))
                            })), _(), x(), $(".index-wrapper .hot .live-type-list").on("click", ".live-type-item", (function() {
                                if (!$(this).hasClass("active"))
                                    if ($(".index-wrapper .hot .live-type-list .live-type-item.active").removeClass("active"), $(this).addClass("active"), $(".index-wrapper .hot .none-data").hide(), $(this).hasClass("all-type")) $(".index-wrapper .hot .all-content").show(), $(".index-wrapper .hot .live-type-content").hide(), 0 === $(".index-wrapper .hot .all-content").children().length && $(".index-wrapper .hot .none-data").show();
                                    else {
                                        var t = [];
                                        ...
                                        t.map((function(t, n) {
                                            e += '\n          <li>\n            <a href="'.concat(f.default.roomUrl(t.roomNum), '">\n              <div class="mask"></div>\n              <img class="fm lazyload live-cover" src="').concat(u.default.cdn, "/assets/").concat(u.default.env, '/img/live-cover.png" data-src="').concat(t.cutOutCustomCoverUrl ? t.cutOutCustomCoverUrl : t.cover, '" data-src-backup="').concat(t.cover, '" />\n              <div class="live-mask"></div>\n              <i class="btn-open"></i>\n              <div class="top-tag float-clear">\n                ').concat(1 === t.markType ? '<span class="tag">\n                    <i i18n-text="官方">'.concat(g.default.official_tag, "</i>\n                  </span>") : 2 === t.markType ? '<span class="com">\n                    <i i18n-text="推荐">'.concat(g.default.recommend_tag, "</i>\n                  </span>") : 3 === t.markType ? '<span class="hots">\n                    <i i18n-text="火爆">'.concat(g.default.hot_tag, "</i>\n                  </span>") : "<span></span>", '\n                <div class="living">\n                  <img src="').concat(u.default.cdn, "/assets/").concat(u.default.env, '/img/living.gif">\n                  <span>Live</span>\n                </div>\n              </div>\n              <h5 class="bottom-title">\n                <span class="name">').concat(t.anchor.nickName, '</span>\n                <span class="num">\n                  <img src="').concat(u.default.cdn, "/assets/").concat(u.default.env, '/img/icon-hot-white.png" srcset="">\n                  <span>').concat(h.default.viewCount(t.viewCount), '</span>\n                </span>\n              </h5>\n              <h4 class="ellipsis">').concat(t.title, "</h4>\n            </a>\n          </li>")
                                        })), $(".index-wrapper .hot .all-content").hide(), $(".index-wrapper .hot .live-type-content").html(e).show(), f.default.loadImg("live"), 0 === $(".index-wrapper .hot .live-type-content").children().length && $(".index-wrapper .hot .none-data").show()
                                    }
                                ...
                                var t = s()(c.a.mark((function t(e) {
                                    ...
                                    return c.a.wrap((function(t) {
                                        for (;;) switch (t.prev = t.next) {
                                            case 0:
                                                if (n = $(this), o = n.attr("data-id"), i = 1 == w[o].reservationStatus ? 2 : 1, d.default.handleLoginJump(!1)) {
                                                    t.next = 13;
                                                    break
                                                }
                                                return a = {
                                                ...
                                                }, t.prev = 3, t.next = 6, d.default.matchReservation(a);
                                            case 6:
                                                s = t.sent, 1 == i && s ? (Object(p.Msg)({
                                                    message: g.default.subscribe_success
                                                }), w[o].reservationStatus = 1, n.addClass("use")) : s && (Object(p.Msg)({
                                                    message: g.default.subscribe_cancel
                                                }), w[o].reservationStatus = 2, n.removeClass("use")), t.next = 13;
                                                break;
                                            case 10:
                        ...
                        r.prototype.THROTTLE_TIMEOUT = 100, r.prototype.POLL_INTERVAL = null, r.prototype.USE_MUTATION_OBSERVER = !0, r._setupCrossOriginUpdater = function() {
                            ...
                            if (n && -1 == this._monitoringDocuments.indexOf(e)) {
                                var o = this._checkForIntersections,
                                    i = null,
                                    s = null;
                                if (this.POLL_INTERVAL ? i = n.setInterval(o, this.POLL_INTERVAL) : (c(n, "resize", o, !0), c(e, "scroll", o, !0), this.USE_MUTATION_OBSERVER && "MutationObserver" in n && (s = new n.MutationObserver(o)).observe(e, {
                                        attributes: !0,
                                        childList: !0,
                                        characterData: !0,
                                        subtree: !0
                                        ...
                                        var t = e.defaultView;
                                        t && (i && t.clearInterval(i), l(t, "resize", o, !0)), l(e, "scroll", o, !0), s && s.disconnect()
                            ...
                            if ("none" != window.getComputedStyle(e).display) {
                                for (var s, r, c, l, d, h, f, v, g = i, y = p(e), w = !1; !w && y;) {
                                    ...
                                    if ("none" == $.display) return null;
                                    if (y == this.root || 9 == y.nodeType)
                                        if (w = !0, y == this.root || y == t) n && !this.root ? !o || 0 == o.width && 0 == o.height ? (y = null, b = null, g = null) : b = o : b = a;
                                        else {
                                            var _ = p(y),
                                                C = _ && u(_),
                                                x = _ && this._computeTargetAndRootIntersection(_, C, a);
                                            C && x ? (y = _, b = m(C, x)) : (y = null, g = null)
                                        }
                                    else {
                                        var I = y.ownerDocument;
                                        y != I.body && y != I.documentElement && "visible" != $.overflow && (b = u(y))
                                    }
                                    if (b && (s = b, r = g, void 0, void 0, void 0, void 0, void 0, void 0, c = Math.max(s.top, r.top), l = Math.min(s.bottom, r.bottom), d = Math.max(s.left, r.left), v = l - c, g = (f = (h = Math.min(s.right, r.right)) - d) >= 0 && v >= 0 && {
                                            top: c,
                                            bottom: l,
                                            left: d,
                                            right: h,
                ...
                return s.a.wrap((function(t) {
                    for (;;) switch (t.prev = t.next) {
                        case 0:
                            z = function() {
                                ...
                                if (t) {
                                    if ("liveRoom" == C) {
                                        ...
                                        1 == r.storeData.isUser ? ($(".send-danmu-input span").hide(), $(".send-danmu-enter").removeClass("cgcolor"), e.attr("placeholder", f.default.send_danmaku_tip), e.attr("contenteditable", !0)) : (e.attr("placeholder", f.default.before_can_speak), e.attr("contenteditable", !1)), $(".send-danmu").show()
                                    }
                                    o.addClass("fullscreen")
                                } else o.removeClass("fullscreen"), $(".send-danmu").hide()
                            }, M = function(t) {
                                var e = document.querySelector(".video-player");
                                e.requestFullscreen ? t ? e.requestFullscreen() : document.exitFullscreen() : e.mozRequestFullScreen ? t ? e.mozRequestFullScreen() : document.mozCancelFullScreen() : e.webkitRequestFullScreen ? t ? e.webkitRequestFullScreen() : document.webkitCancelFullScreen() : e.msRequestFullscreen && (t ? e.msRequestFullscreen() : document.msExitFullscreen()), N(t)
                            }, U = function() {
                                var t = document.webkitIsFullScreen || document.mozFullScreen || document.msFullscreenElement || document.fullscreenElement;
                                return null != t && null != t || (t = !1), t
                            }, B = function(t) {
                                if (isShowMinScreen = t, v && 1 == v.room.liveStatus)
                                    if (t) {
                                        n.show(), o.hide(), e.addClass("min-screen");
                                        var i = 0,
                                            a = 0,
                                            s = 0,
                                            r = 0,
                                        ...
                                        $(".min-screen").mousedown((function(t) {
                                            i = t.clientX, a = t.clientY, s = $(".min-screen").get(0).offsetLeft, r = $(".min-screen").get(0).offsetTop, c = !0, $(".min-screen").get(0).style.cursor = "move", window.onmousemove = function(t) {
                                                if (0 != c) {
                                                    var e = t.clientX,
                                                        n = t.clientY,
                                                        o = e - (i - s),
                                                        l = n - (a - r);
                                                    $(".min-screen").get(0).style.left = o + "px", $(".min-screen").get(0).style.top = l + "px"
                                                }
                                            }, $(".min-screen").mouseup((function() {
                                                c = !1, $(".min-screen").get(0).style.cursor = "default"
                                            }))
                                        }))
                                    } else $(".min-screen").off("mousedown"), $(".min-screen").off("mouseup"), document.onmousemove = null, e.get(0).style.left = null, e.get(0).style.top = null, n.hide(), e.removeClass("min-screen")
                            }, S = function() {
                                L && window.pageYOffset >= L ? B(!0) : B(!1)
                            }, D = function(t) {
                                t ? ($("#danmuBtn").removeClass("video-open-danmu"), $("#danmuBtn").addClass("video-close-danmu"), I(0)) : ($("#danmuBtn").addClass("video-open-danmu"), $("#danmuBtn").removeClass("video-close-danmu"), I(1))
                            }, O = function() {
                                return $(".volumn-slider").unbind("mousemove", E), $(document).unbind("mouseup", O), !1
                            }, E = function(t) {
                                var e = $(this),
                                    n = (t.clientX - e.offset().left) / e.width() * 100;
                                return k(n), n <= 0 ? n = 0 : n >= 100 && (n = 100), e.children(".volumn-line").css({
                                    width: n + "%"
                                ...
                                if (0 == t.button) {
                                    var e = $(this),
                                        n = (t.clientX - e.offset().left) / e.width() * 100;
                                    n > 0 && ($("#volumnBtn").removeClass("icon-volume"), $("#volumnBtn").addClass("icon-close-volume")), k(n), e.children(".volumn-line").css({
                                        width: n + "%"
                                    }), e.children(".volumn-point").css({
                                        left: n + "%"
                                    }), e.bind("mousemove", E), $(document).bind("mouseup", O)
                                }
                                return !1
                            }, k = function(t) {
                                var e = t / 100 < 0 ? 0 : t / 100;
                                e = e > 1 ? 1 : e, "function" == typeof h.volume ? h.volume(e, !0, !1) : h.volume = e
                            }, T = function(t) {
                                var e = "",
                                    n = flvjs.isSupported();
                                e = "2" !== d.default.debug ? 1 == y ? t.stream.m3u8 : t.stream.hdM3u8 : "https://live.cgtn.com/1000/prog_index.m3u8", b = !1, w = null, h = null, n && t.stream.flv && t.stream.hdFlv ? (e = 1 == y ? t.stream.flv : t.stream.hdFlv, $("#dplayer").html('<video name="videoElement" style="width:100%;height:100%" id="dplayerVideo" class="centeredVideo" autoplay>Your browser is too old which doesn\'t support HTML5 video.</video>\n            '), (h = flvjs.createPlayer({
                                    type: "flv",
                                    isLive: !0,
                                    url: e,
                                    hasAudio: !0,
                                ...
                                })).attachMediaElement(document.getElementById("dplayerVideo")), h.load()) : h = new DPlayer({
                                    ...
                                    video: {
                                        ...
                                        customType: {
                                            customHls: function(t, e) {
                                                (w = new Hls({
                                                    autoStartLoad: !1
                                                })).loadSource(t.src), w.attachMedia(t)
                                            }
                                        }
                                    },
                                    theme: "#FFC71C"
                                ...
                                if (o) {
                                    ...
                                    o.then((function() {
                                        ...
                                        i = !1, $("#playBtn").removeClass("video-play"), $("#playBtn").addClass("video-pause"), $("#min-play").removeClass("video-play"), $("#min-play").addClass("video-pause"), $(".big-play-btn").show(), w && w.stopLoad()
                                    })), setTimeout((function() {
                                        i && w && w.startLoad()
                                    }), 1e3)
                                }
                                console.log(t), 1 == t.room.liveStatus ? a.hide() : "index" == C ? (a.hide(), setTimeout((function() {
                                    $(".big-play-btn").hide()
                                }), 10)) : a.show(), h.on("error", (function() {
                                    console.log("error"), clearTimeout(_)
                                })), h.on("waiting", (function() {
                                    console.log("waiting"), $("#videoLoading").show(), clearTimeout(_), _ = setTimeout((function() {
                                        T(v), h.play()
                                    }), 3e4)
                                })), h.on("canplay", (function() {
                                    console.log("canplay"), $("#videoLoading").hide(), clearTimeout(_)
                                })), h.on("playing", (function() {
                                    console.log("playing"), $("#videoLoading").hide(), clearTimeout(_)
                                })), h.on("play", (function() {
                                    console.log("play"), b ? (b = !1, T(v), console.log("hls create")) : w && (w.startLoad(), console.log("hls startload"))
                                })), h.on("ended", (function() {
                                    console.log("ended"), T(v), clearTimeout(_)
                                })), h.on("pause", (function() {
                                    h.video.paused && (console.log("pause"), $("#videoLoading").hide(), clearTimeout(_), w && (w.stopLoad(), w.destroy(), w = null, b = !0, console.log("hls destroy")))
                                })), "index" == C && ($(".inLiveRoom").show(), $(".goRoom").show()), "liveRoom" == C && (h.play(), $(".mute-tips").hide(), $(".bottomCtrlRight").hide(), $(".bottomCtrlRight.inRoom").show()), "player" == C && $(".goRoom").hide(), $(".dplayer-controller").hide(), $(".dplayer-danloading").hide(), $(".dplayer-bezel").hide()
                            }, I = function(t) {
                                x.options = {
                                    hiddenTypes: t
                                }
                            }, e = $(".video-player"), n = e.find(".min-screen-mark"), o = e.find(".bottomCtrl"), a = e.find(".vplayer-recommend"), v = null, y = 2, w = null, b = !1, _ = null, g = c.default.getRoomNum(), C = $("#video-player-tag").attr("tag"), (x = new openBSE.GeneralEngine(document.getElementsByClassName("bullet-wrapper")[0], {
                                defaultStyle: {
                                    fontFamily: '"Microsoft YaHei","PingFang SC",SimHei,"Heiti SC",sans-serif',
                                    fontWeight: "normal",
                                    shadowBlur: 4
                                }
                            }, "css3")).play(), r.storeData.generalEngine = x, D(!1), "liveRoom" != C && "player" != C || F(g), $("#refresh").click((function() {
                                $(".refresh").hide(), T(v)
                            })), $(".volumn-slider").bind("mousedown", R), $(".mute-tips img").click((function() {
                                $(".mute-tips").fadeOut()
                            })), setTimeout((function() {
                                $(".mute-tips").fadeOut()
                                ...
                                if (t.hasClass("icon-volume")) {
                                    t.removeClass("icon-volume"), t.addClass("icon-close-volume");
                                    var e = $(".volumn-slider .volumn-line").width() / 120;
                                    k(100 * e)
                                } else t.addClass("icon-volume"), t.removeClass("icon-close-volume"), k(0)
                            })), $("#playBtn, #min-play, #dplayer, .big-play-btn").click((function(t) {
                                return c.default.stopBubble(t), $("#playBtn").hasClass("video-play") ? ($("#playBtn").removeClass("video-play"), $("#playBtn").addClass("video-pause"), $("#min-play").removeClass("video-play"), $("#min-play").addClass("video-pause"), $(".big-play-btn").show(), h.pause()) : ($("#playBtn").addClass("video-play"), $("#playBtn").removeClass("video-pause"), $("#min-play").addClass("video-play"), $("#min-play").removeClass("video-pause"), $(".big-play-btn").hide(), h.play()), !1
                            })), $(".select-definition span").click((function() {
                                return $(".select-opt").fadeIn(), !1
                            })), $(".select-opt div").click((function() {
                                var t = $(this),
                                    e = $(this).attr("data-id");
                                t.hasClass("active") || ($(".select-opt div").removeClass("active"), t.addClass("active"), $(".select-definition span").html(t.html()), y = e, T(v))
                            })), $("body").click((function() {
                                $(".select-opt").fadeOut()
                            })), $("#danmuBtn").click((function() {
                                $(this).hasClass("video-open-danmu") ? D(!0) : D(!1)
                            })), "liveRoom" == C && window.addEventListener("scroll", S), L = 400, n.find(".icon-close").click((function(t) {
                                c.default.stopBubble(t), document.onmousedown = null, document.onmousemove = null, document.onmouseup = null, window.removeEventListener("scroll", S), B(!1)
                            })), $(".video-full").click((function() {
                                U() ? M(!1) : M(!0)
                            })), window.onresize = function() {
                                U() || N(!1)
                            }, $(".bottomCtrlRight .copy").click((function() {
                                r.storeData.room && r.storeData.room.contact && (c.default.copyToClip(r.storeData.room.contact), Object(m.Msg)({
                                    message: f.default.copy_success
                                }))
                            })), $(".room-list").on("click", "li", (function(t) {
                                $(".room-list li a.active").removeClass("active"), $(this).children("a").addClass("active"), F($(this).attr("data-roomnum"))
                            ...
                            })), q = 0, $(".video-player, .inLiveRoom").mousemove((function(t) {
                                e.hasClass("min-screen") || (q = (new Date).getTime(), o.show())
