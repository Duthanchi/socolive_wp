(window.webpackJsonp = window.webpackJsonp || []).push([[14], {
                ...
                var t = {
                  ...
                  , a = function e() {
                    ...
                    t++); t < a; t++)
                        !function(t) {
                            for (var a in t)
                                Object.prototype.hasOwnProperty.call(t, a) && (o && "[object Object]" === Object.prototype.toString.call(t[a]) ? n[a] = e(!0, n[a], t[a]) : n[a] = t[a])
                        }(arguments[t]);
                    return n
                };
                if (n.prototype = {
                            ...
                            this.observer = new IntersectionObserver((function(e) {
                                Array.prototype.forEach.call(e, (function(e) {
                                    if (e.isIntersecting) {
                                        ...
                                        t && (e.target.srcset = t)) : e.target.style.backgroundImage = "url(" + o + ")"
                                    }
                                }
                                ))
                            }
                    ...
                    loadImages: function() {
                        if (this.settings) {
                            ...
                            Array.prototype.forEach.call(this.images, (function(n) {
                                ...
                                "img" === n.tagName.toLowerCase() ? (o && (n.src = o),
                                t && (n.srcset = t)) : n.style.backgroundImage = "url('" + o + "')"
                            }
                            ))
                        }
                    },
        ...
        !function() {
            if ("object" === ("undefined" == typeof window ? "undefined" : a()(window)))
                if ("IntersectionObserver"in window && "IntersectionObserverEntry"in window && "intersectionRatio"in window.IntersectionObserverEntry.prototype)
                    ...
                    var e = function(e) {
                        for (var n = window.document, o = r(n); o; )
                            o = r(n = o.ownerDocument);
                        return n
                    }()
                      , n = []
                      , o = null
                    ...
                    u.prototype._monitorIntersections = function(n) {
                        ...
                        if (o && -1 == this._monitoringDocuments.indexOf(n)) {
                            var t = this._checkForIntersections
                              , a = null
                              , i = null;
                            if (this.POLL_INTERVAL ? a = o.setInterval(t, this.POLL_INTERVAL) : (c(o, "resize", t, !0),
                            c(n, "scroll", t, !0),
                            this.USE_MUTATION_OBSERVER && "MutationObserver"in o && (i = new o.MutationObserver(t)).observe(n, {
                                attributes: !0,
                                childList: !0,
                                characterData: !0,
                                subtree: !0
                        ...
                        if ("none" != window.getComputedStyle(n).display) {
                            for (var i, u, c, d, y, l, h, g, p = a, C = N(n), H = !1; !H && C; ) {
                                ...
                                if (C == this.root || 9 == C.nodeType)
                                    if (H = !0,
                                    C == this.root || C == e)
                                        o && !this.root ? !t || 0 == t.width && 0 == t.height ? (C = null,
                                        w = null,
                                        p = null) : w = t : w = r;
                                    else {
                                        var S = N(C)
                                ...
                                void 0,
                                void 0,
                                c = Math.max(i.top, u.top),
                                d = Math.min(i.bottom, u.bottom),
                                y = Math.max(i.left, u.left),
                                g = d - c,
                                p = (h = (l = Math.min(i.right, u.right)) - y) >= 0 && g >= 0 && {
                                    top: c,
                                    bottom: d,
                                    left: y,
                                    right: l,
            ...
            function i(e) {
                ...
                this.rootBounds = y(e.rootBounds),
                this.boundingClientRect = y(e.boundingClientRect),
                this.intersectionRect = y(e.intersectionRect || {
                    top: 0,
                    bottom: 0,
                    left: 0,
                    right: 0,
    ...
    180: function(e, n, o) {
        ...
        var t = o(0)
          ...
          , s = o(2)
          , y = o(18);
        if (d.storeData.sessionId || a.default.handleGuestLogin(),
        u.default.handleSpecialCodeByPhone(".register-window"),
        $((function() {
            console.log("$header start"),
            u.default.loadImg(),
            u.default.showDownload((function() {
                $(".right-fix .code").show(),
            ...
            function p(e) {
                e ? $(".index-wrapper").length > 0 ? ($(".header-wrapper").addClass("active"),
                $(".header-logo").show(),
                $(".header-logo-active").hide()) : ($(".header-wrapper").addClass("active-white"),
                $(".header-logo").hide(),
                $(".header-logo-active").show()) : ($(".header-wrapper").removeClass("active").removeClass("active-white"),
                $(".header-logo").show(),
            ...
            $(".download-menu a").attr("href", t.default.downloadAppUrl),
            1 == d.storeData.loginWindow && (Y(1),
            d.storeData.loginWindow = 0),
            g(),
            ...
            a.default.handleIsHadUserLogin()) {
                if ($(".header-right .had-login").show(),
                $(".header-avatar .avatar").attr("data-src", e.cutOutIcon ? e.cutOutIcon : e.icon).attr("data-src-backup", e.icon),
                $(".avatar-submenu .avatar").attr("data-src", e.cutOutIcon ? e.cutOutIcon : e.icon).attr("data-src-backup", e.icon),
                $(".avatar-submenu .nickname").text(e.nickName),
                ...
                $(".avatar-submenu .cur-grow").text(e.grow),
                $(".avatar-submenu .max-grow").text(e.growDto.nextMinGrom),
                $(".avatar-submenu .diff-grow").text(e.growDto.nextMinGrom - e.grow),
                $(".avatar-submenu .grow-progress").attr({
                    max: e.growDto.nextMinGrom,
                    value: e.grow
                }),
                2 == e.userType && ($(".avatar-submenu .identity").text(s.default.anchor),
                $(".avatar-submenu .identity").show(),
                $(".avatar-submenu").find(".anchor-center").show()),
                3 == e.userType && ($(".avatar-submenu .identity").text(s.default.admin),
                $(".avatar-submenu .identity").show()),
                d.storeData.subscribeList && d.storeData.subscribeList.length > 0) {
                    var C = "";
                    try {
                    ...
                    $(".header-wrapper .subscribe-data").find(".subscribe-data-box").append(C),
                    ...
                    $(".header-wrapper .subscribe-data").find(".more").click((function() {
                ...
                a.default.liveAttentionList().then((function(e) {
                    e && (e.comperes || (e.comperes = []),
                    d.storeData.concernList = e.comperes)
                }
                ))
            } else
                $(".header-right .no-login").show();
            function H() {
                d.storeData.remeberLogin && 0 !== Object.getOwnPropertyNames(d.storeData.remeberLogin).length && (d.storeData.remeberLogin.phone && d.storeData.remeberLogin.phone.length > 0 ? ($(".login-window .window-inner").find(".country-code").text(d.storeData.remeberLogin.countryCode),
                $(".login-window .window-inner").find(".input-phone").val(d.storeData.remeberLogin.phone),
                $(".login-window .window-inner").find(".input-password").val(u.default.aesCbcDecrypt(d.storeData.remeberLogin.password, t.default.remeberKey)),
                $(".login-window .window-inner").find(".account-box .input-group").addClass("readonly")) : ($(".login-window .window-inner").find(".input-account").val(d.storeData.remeberLogin.account),
                $(".login-window .window-inner").find(".input-password").val(u.default.aesCbcDecrypt(d.storeData.remeberLogin.password, t.default.remeberKey)),
            ...
            function w(e) {
                var n = "";
                return $(".".concat(e, "-window .phone-box .input-group")).hasClass("readonly") && (n = "account"),
                $(".".concat(e, "-window .account-box .input-group")).hasClass("readonly") && (n = "phone"),
                n
            }
            function f(e) {
            ...
            function S() {
                if ($(".login-window .remeber-box .gou").length > 0 && $(".login-window .remeber-box .gou").hasClass("active")) {
                    var e = f("login")
                      , n = {};
                    e.find(".input-account").val() ? n.account = e.find(".input-account").val() : (n.countryCode = e.find(".country-code").text(),
                    n.phone = e.find(".input-phone").val()),
                    n.password = u.default.aesCbcEncrypt(e.find(".input-password").val(), t.default.remeberKey),
                    d.storeData.remeberLogin = n
                } else
                    d.storeData.remeberLogin = {}
            }
            function k(e) {
                1 == e && ($(".login-window .input-account").val(""),
                $(".login-window .input-phone").val(""),
                $(".login-window .input-password").val(""),
                $(".login-window .country-code").text(s.default.country_code),
                T(!1, 1),
                U(!1, 1),
                $(".login-window").find(".error-tip>span").hide(),
                H()),
                2 == e && ($(".register-window .input-account").val(""),
                ...
                $(".register-window .country-code").text(s.default.country_code),
            ...
            function T(e, n) {
                e ? (1 == n && ($(".login-window .input-password").attr("type", "text"),
                $(".login-window .ali-zhenyan").show(),
                $(".login-window .ali-biyan").hide()),
                2 == n && ($(".register-window .input-password").attr("type", "text"),
                $(".register-window .ali-zhenyan").show(),
                $(".register-window .ali-biyan").hide())) : (1 == n && ($(".login-window .input-password").attr("type", "password"),
                $(".login-window .ali-zhenyan").hide(),
                $(".login-window .ali-biyan").show()),
                2 == n && ($(".register-window .input-password").attr("type", "password"),
            ...
            function Y(e) {
                1 == e ? ($(".login-window").show(),
                k(1),
                W(2)) : 2 == e && ($(".register-window").show(),
                k(2),
                W(1)),
                $(".header-modal").show()
            }
            ...
            function() {
                for (var e = "zh" === s.default.language ? r : i, n = "", o = 0; o < e.length; o++) {
                    ...
                    for (var t = e[o].list, a = 0; a < t.length; a++)
                        "zh" === s.default.language ? n += '<li class="country-code-item"><span class="left">'.concat(t[a].countryName, '</span><span class="right">').concat(t[a].countryCode, "</span></li>") : n += '<li class="country-code-item"><span class="left">'.concat(t[a].countryNameUS, '</span><span class="right">').concat(t[a].countryCode, "</span></li>")
                }
                $(".login-window").find(".country-code-list ul").html(n),
                $(".register-window").find(".country-code-list ul").html(n)
            }(),
            ...
            $(".logout-confirm .yes").click((function() {
                $(".logout-confirm").hide(),
                a.default.handleUserLogout().then((function(e) {}
                ))
            }
            )),
            $(".logout-confirm .no").click((function() {
                return $(".logout-confirm").hide(),
                !1
            }
            )),
                ...
                if (o) {
                    ...
                    a.default.getSmsCode(e).then((function(e) {
                        ...
                        l = setInterval((function() {
                            m--,
                            $(".register-window .verify-text").text(m + "s"),
                            m <= 0 && (o = !0,
                            n ? $(".register-window .verify-text").text(s.default.input_verify_resend) : $(".register-window .verify-text").text(s.default.input_verify_btn),
                            clearInterval(l))
                        }
                        ), 1e3)
                    }
            ...
            $(".login-window").find("input").on("input", (function() {
                !function() {
                    ...
                    o ? ($(".login-window .account-box .input-group").addClass("readonly"),
                    $(".login-window .account-box .input-account").attr("readonly", !0),
                    e.find(".account-box>.error-tip>span").hide()) : ($(".login-window .account-box .input-group").removeClass("readonly"),
                    $(".login-window .account-box .input-account").attr("readonly", !1)),
                    a ? ($(".login-window .phone-box .input-group").addClass("readonly"),
                    $(".login-window .phone-box .input-phone").attr("readonly", !0),
                    e.find(".phone-box>.error-tip>span").hide()) : ($(".login-window .phone-box .input-group").removeClass("readonly"),
                    $(".login-window .phone-box .input-phone").attr("readonly", !1));
                    var r = [];
                    y.default.password(t) && (e.find(".password-box>.error-tip>span").hide(),
                    r.password = !0),
                    "account" === w("login") ? (y.default.account(a) && (e.find(".account-box>.error-tip>span").hide(),
                    r.account = !0),
                    r.account && r.password ? U(!0, 1) : U(!1, 1)) : "phone" === w("login") && (y.default.specialCountryCodePhone(n, o) && (e.find(".phone-box>.error-tip>span").hide(),
                    r.countryCodePhone = !0),
                    r.countryCodePhone && r.password ? U(!0, 1) : U(!1, 1))
                }()
            }
            )),
            $(".register-window").find("input").on("input", (function() {
                !function() {
                    ...
                    o ? ($(".register-window .account-box .input-group").addClass("readonly"),
                    $(".register-window .account-box .input-account").attr("readonly", !0),
                    u.default.isSpecialCode(n) || $(".register-window .verify-box").show(),
                    $(".register-window .check-box").show(),
                    e.find(".account-box>.error-tip>span").hide()) : ($(".register-window .verify-box").hide(),
                    $(".register-window .check-box").hide(),
                    $(".register-window .account-box .input-group").removeClass("readonly"),
                    $(".register-window .account-box .input-account").attr("readonly", !1)),
                    c ? ($(".register-window .phone-box .input-group").addClass("readonly"),
                    $(".register-window .phone-box .input-phone").attr("readonly", !0),
                    e.find(".phone-box>.error-tip>span").hide(),
                    e.find(".captcahr-box").show()) : ($(".register-window .phone-box .input-group").removeClass("readonly"),
                    $(".register-window .phone-box .input-phone").attr("readonly", !1),
                    e.find(".captcahr-box").hide());
                    var d = [];
                    y.default.nickname(a) && (e.find(".nickname-box>.error-tip>span").hide(),
                    d.nickname = !0),
                    y.default.password(r) && (e.find(".password-box>.error-tip>span").hide(),
                    d.password = !0),
                    "account" === w("register") ? (y.default.account(c) && (e.find(".account-box>.error-tip>span").hide(),
                    d.account = !0),
                    d.nickname && d.password && d.account ? U(!0, 2) : U(!1, 2)) : "phone" === w("register") && (y.default.countryCodePhone(n, o) && (e.find(".phone-box>.error-tip>span").hide(),
                    d.countryCodePhone = !0),
                    y.default.smsCode(t) && (e.find(".verify-box>.error-tip>span").hide(),
                    d.smsCode = !0),
                    y.default.imgCode(i) && (e.find(".check-box>.error-tip>span").hide(),
                    d.check = !0),
                    d.countryCodePhone && d.smsCode && d.nickname && d.password && d.check ? U(!0, 2) : U(!1, 2))
                }()
            }
            )),
            H(),
            $(".header-window").find(".input-password").blur((function() {
            ...
            $(".header-window").find(".input-account").blur((function() {
                y.default.account($(this).val()) || $(this).closest(".input-group").next(".error-tip").find("span").show(),
                f("register").find(".captcahr-box .check-img").click()
            }
            )),
            ...
            $(".register-window").find(".input-phone").blur((function() {
                var e = $(this).closest(".input-group");
                y.default.countryCodePhone(e.find(".country-code").text(), $(this).val()) || $(this).closest(".input-group").next(".error-tip").find("span").show(),
                "phone" === w("register") && f("register").find(".check-box .check-img").click()
            }
            )),
            ...
            $(".login-window .submit").click((function() {
                ...
                if (N) {
                    ...
                    if ("account" === w("login")) {
                        ...
                        S(),
                        a.default.handleUserLogin(r).then((function(e) {
                            W(1)
                        }
                        )).catch((function(e) {}
                        ))
                        ...
                        S(),
                        a.default.handleUserLogin(i).then((function(e) {
                            W(1)
                        }
                        )).catch((function(e) {}
                        ))
        ...
        d.storeData.newMsg) {
            ...
            d.storeData.newMsg = 0,
            d.storeData.newMsg = m
        }
        if (d.storeData.feedbackMsg) {
            var l = d.storeData.feedbackMsg;
            d.storeData.feedbackMsg = 0,
            d.storeData.feedbackMsg = l
        }
        if (d.storeData.privateMsg) {
            var N = d.storeData.privateMsg;
            d.storeData.privateMsg = 0,
            d.storeData.privateMsg = N
        }
