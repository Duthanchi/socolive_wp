(window.webpackJsonp = window.webpackJsonp || []).push([
    ...
    [function(t, e, n) {
        ...
        "use strict";
        n.r(e), n.d(e, "storeData", (function() {
            return u
        }));
        var o = n(0),
            r = n(59),
            ...
            u = new r.default({
                ...
                watch: {
                    levelUpShow: function(t, e) {
                        if (t) {
                            var n = $(".level-mode");
                            n.length > 0 && (n.show(), setTimeout((function() {
                                n.fadeOut(150), u.levelUpShow = !1
                            }), 3e3))
                        }
                    },
                    ...
                    userInfo: function(t, e) {
                        window.localStorage.setItem("userInfo", JSON.stringify(t)), $(".header-wrapper .had-login .avatar-submenu .nickname").text(t.nickName)
                    },
                    isUser: function(t, e) {
                        window.localStorage.setItem("isUser", JSON.stringify(t)), 1 != t && ($(".header-wrapper").find(".had-login").hide(), $(".header-wrapper").find(".no-login").show())
                    },
                    sysNoticeList: function(t, e) {
                        if (window.sessionStorage.setItem("sysNoticeList", JSON.stringify(t)), t && 0 != t.length) {
                            var n = t[0],
                            ...
                            $(".my-message-content").find(".content").prepend(r), $(".my-message-content").find(".none").hide()
                        }
                    },
                    newMsg: function(t, e) {
                        0 != t ? ($(".avatar-submenu .bottom-btn.msg .msg-num").show(), $(".my-menu-wrapper .item.msg .msg-num").show(), $(".header-avatar .newMsg").show()) : l(), window.sessionStorage.setItem("newMsg", JSON.stringify(t))
                    },
                    feedbackMsg: function(t, e) {
                        0 != t ? ($(".header-avatar .newMsg").show(), $(".avatar-submenu .bottom-btn.ucenter .msg-num").show(), $(".my-menu-wrapper .item.feedback .msg-num").show()) : l(), window.sessionStorage.setItem("feedbackMsg", JSON.stringify(t))
                    },
                    privateMsg: function(t, e) {
                        0 != t ? ($(".header-avatar .newMsg").show(), $(".avatar-submenu .bottom-btn.ucenter .msg-num").show(), $(".my-menu-wrapper .item.private-chat .msg-num").show()) : l(), window.sessionStorage.setItem("privateMsg", JSON.stringify(t))
                    },
                    ...
                    subscribeList: function(t, e) {
                        ...
                        t.forEach((function(t) {
                            c = "", t.anchors.forEach((function(t) {
                        ...
                        })), a.html(s), n.show(), r.hide(), i.default.loadImg("avatar")
                    },
                    subscribeToast: function(t, e) {
                        ...
                        n.html(r), n.fadeIn(), setTimeout((function() {
                            n.fadeOut()
                        }), 5e3), n.on("click", ".submenu-box", (function() {
                            var t = u.subscribeToast;
                            if (t) {
                                if (1 == t.openType || 3 == t.openType) return void window.open(t.redirectUrl);
                                if (2 == t.openType) {
                    ...
                    concernList: function(t, e) {
                        if (window.sessionStorage.setItem("concernList", JSON.stringify(t)), t && t.length > 0) {
                            var n = "",
                                r = t,
                                a = (r = r.filter((function(t) {
                                    return 1 == t.liveStatus
                                }))).length >= 4 ? 4 : r.length;
                            if (0 == a) return $(".header-wrapper .concern-data").hide(), void $(".header-wrapper .concern-none").show();
                            for (var s = 0; s < a; s++) {
                                var c = r[s];
                            ...
                            $(".header-wrapper .concern-data").find(".concern-data-box").append(n), $(".header-wrapper .concern-data").show(), $(".header-wrapper .concern-none").hide(), i.default.loadImg("avatar", ".concern-card "), $(".header-wrapper .concern-data").find(".concern-card").click((function() {
                        ...
                        } else $(".header-wrapper .concern-data").hide(), $(".header-wrapper .concern-none").show()
                    },
                        ...
                        if ((t = t[0]).roomNum == i.default.getRoomNum()) {
                            ...
                            if (0 !== n.length) {
                                var r = u.anchorId,
                                    ...
                                    d = $("#chat-list"),
                                    p = !1;
                                if (n.height() > d.height() && (n.height() - (d.scrollTop() + d.height()) < 150 ? p = !0 : $(".newMsg-tips").fadeIn(50)), n.append(l), p && d.scrollTop(n.height()), 3 == u.userInfo.userType || 2 == u.userInfo.userType && u.userInfo.uid == u.anchorId) {
                                    var h = u.commentUserList;
                                    h[t.sendUid] = t.sendUser, u.commentUserList = h
                                }
                                if (2 === t.msgType && !u.shieldGift) {
                                    ...
                                    setTimeout((function() {
                                        ...
                                        g.css("transform", "translate(0%, -100%)"), g.css("margin-bottom", "0"), g.css("opacity", 0), setTimeout((function() {
                                            g.remove()
                                        }), 300)
                                    }), 3e3)
                                }
                    ...
                    barrageItem: function(t, e) {
                        u.generalEngine && (t = a.default.barrage(t), u.generalEngine.add({
                            text: t,
                    ...
                    room: function(t, e) {
                        $(".media .text-title").html(t.title), $(".media .head-img").attr("data-src", t.anchor.cutOutIcon ? t.anchor.cutOutIcon : t.anchor.icon).attr("data-src-backup", t.anchor.icon), $(".media .text-msg .nickName").html(t.anchor.nickName), $(".media .text-msg .room-num").html(s.default.room_num + ":" + t.roomNum), $(".media .text-msg .view-num").html(t.viewCount), i.default.loadImg("avatar");
                        var n = "";
                    ...
                    growScoreUp: function(t, e) {
                        var n = $(".grow-score-up-submenu"),
                            r = "",
                            a = !1;
                        n.find(".grow-score-tip").text(t.content), t.grow > 0 && (r += "".concat(s.default.experience, "+").concat(t.grow), a = !0), t.score && t.score > 0 && (a && (r += "，"), r += "".concat(o.default.scoreName, "+").concat(t.score)), n.find(".value").text(r), n.fadeIn(), setTimeout((function() {
                            n.fadeOut()
                        }), 5e3)
                    },
                    friend: function(t, e) {
        ...
        function l() {
            u.feedbackMsg <= 0 && u.newMsg <= 0 && u.privateMsg <= 0 && $(".header-avatar .newMsg").hide(), u.feedbackMsg <= 0 && u.privateMsg <= 0 && $(".avatar-submenu .bottom-btn.ucenter .msg-num").hide(), u.newMsg <= 0 && ($(".avatar-submenu .bottom-btn.msg .msg-num").hide(), $(".my-menu-wrapper .item.msg .msg-num").hide()), u.feedbackMsg <= 0 && $(".my-menu-wrapper .item.feedback .msg-num").hide(), u.privateMsg <= 0 && $(".my-menu-wrapper .item.private-chat .msg-num").hide()
        }
    }, function(t, e, n) {
        "use strict";
        n.r(e), e.default = {
        ...
        n(14), n(16), e.default = {
            ...
            base64toFile: function(t) {
                for (var e = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : "file", n = t.split(","), o = n[0].match(/:(.*?);/)[1], r = o.split("/")[1], a = atob(n[1]), i = a.length, s = new Uint8Array(i); i--;) s[i] = a.charCodeAt(i);
            ...
            copyToClip: function(t) {
                ...
                if (l.setAttribute("value", t), document.body.appendChild(l), n || o || r || a || i || s || c || u) {
                    var d = document.createRange();
                    d.selectNode(l);
                    var p = window.getSelection();
                    p.rangeCount > 0 && p.removeAllRanges(), p.addRange(d), document.execCommand("copy"), document.body.removeChild(l), p.removeAllRanges()
                } else l.select(), document.execCommand("copy"), document.body.removeChild(l)
            },
            loadImg: function(t, e) {
                ...
                switch (t) {
                    case "avatar":
                        n = "".concat(o.default.cdn, "/assets/").concat(o.default.env, "/img/avatar.png"), r = ".avatar";
                        break;
                    case "live":
                    default:
                        n = "".concat(o.default.cdn, "/assets/").concat(o.default.env, "/img/live-cover.png"), r = ".live-cover";
                        break;
                    case "banner":
                        n = "".concat(o.default.cdn, "/assets/").concat(o.default.env, "/img/banner-cover.png"), r = ".banner-cover";
                        break;
                    case "match":
                        n = "".concat(o.default.cdn, "/assets/").concat(o.default.env, "/img/match-cover.png"), r = ".match-cover"
                }
                $("".concat(e).concat(r, ".lazyload")).one("error", (function() {
                    $(this).attr("data-src-backup") ? ($(this).attr("src", $(this).attr("data-src-backup")), $(this).one("error", (function() {
                        $(this).attr("src", n)
                    }))) : $(this).attr("src", n)
            ...
            getRoomNum: function() {
                for (var t = "", e = location.pathname.split("/"), n = 0; n < e.length; n++)
                    if ("room" == e[n] && e[n + 1]) {
                        t = e[n + 1];
                        break
                    } return t || (t = this.getUrlParam("roomNum")), t
            },
            roomUrl: function(t) {
            ...
            uuid: function(t, e) {
                var n, o, r = "0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz".split(""),
                    a = [];
                if (e = e || r.length, t)
                    for (n = 0; n < t; n++) a[n] = r[0 | Math.random() * e];
                else
                    for (a[8] = a[13] = a[18] = a[23] = "-", a[14] = "4", n = 0; n < 36; n++) a[n] || (o = 0 | 16 * Math.random(), a[n] = r[19 == n ? 3 & o | 8 : o]);
                return a.join("")
            },
            ...
            aesCbcEncrypt: function(t, e) {
                var n = s.a.enc.Base64.parse(e),
                    o = n.clone();
                o.sigBytes = 16, o.words.splice(4);
            ...
            handleSpecialCode: function(t) {
                ...
                $("".concat(t, " .country-code-box .country-code")).bind("DOMNodeInserted", (function() {
                    e.isSpecialCode($(this).text()) ? ($(this).closest(".input-container").find(".verify-box").hide(), $(this).closest(".input-container").find(".verify-box .input-verify").val("8888")) : ($(this).closest(".input-container").find(".verify-box .input-verify").val(""), $(this).closest(".input-container").find(".verify-box").show())
                }))
            },
            handleSpecialCodeByPhone: function(t) {
                ...
                var e = this;
                $("".concat(t, " .country-code-box .country-code")).bind("DOMNodeInserted", (function() {
                    e.isSpecialCode($(this).text()) ? ($(this).closest(".input-container").find(".verify-box").hide(), $(this).closest(".input-container").find(".verify-box .input-verify").val("8888")) : ($(this).closest(".input-container").find(".verify-box .input-verify").val(""), $(this).closest(".phone-box").find(".input-phone").val() && $(this).closest(".input-container").find(".verify-box").show())
                }))
            },
            ...
            hostIncludes: function(t) {
                if (t && t.length > 0) {
                    ...
                    try {
                        for (n.s(); !(e = n.n()).done;) {
                            var o = e.value;
                            if ("" != o && location.host.includes(o)) return !0
                        }
                    } catch (t) {
                        n.e(t)
                    } finally {
        ...
        function p(t, e, n, o) {
            ...
            if (u.default.roomDomain && a != u.default.roomDomain && "0" == u.default.debug) {
                var s = {};
                s.isUser = o, s.sessionId = t, s.userInfo = e, s.urls = n, s.domain = a, $(document.body).append('<iframe id="corsIframe" src="'.concat(u.default.roomDomain, "/cors.html?v=").concat((new Date).getTime(), '" style="display:none;"></iframe>'));
                var c = document.getElementById("corsIframe");
                c.onload = r()(i.a.mark((function t() {
                    return i.a.wrap((function(t) {
                        for (;;) switch (t.prev = t.next) {
                            case 0:
                                return t.next = 2, c.contentWindow.postMessage(JSON.stringify(s), "".concat(u.default.roomDomain));
                            case 2:
        ...
        e.default = {
                ...
                return r()(i.a.mark((function e() {
                    ...
                    return i.a.wrap((function(e) {
                        for (;;) switch (e.prev = e.next) {
                            case 0:
                                return console.log("游客登录"), c.storeData.sessionId = "", c.storeData.userInfo = "", c.storeData.urls = "", e.next = 6, t.visitorLogin();
                            case 6:
                                n = e.sent, c.storeData.sessionId = n.sessionId, c.storeData.userInfo = n.userInfo, c.storeData.isUser = 0, c.storeData.sysNoticeList = [], c.storeData.concernList = null, l.default.send(u.default.WS_CODE.LOGIN, {
                                    key: n.sessionId,
                                    plat: 3,
                                    version: 1
                                });
            ...
            handleUserLogin: function(t, e) {
                ...
                return r()(i.a.mark((function e() {
                    ...
                    return i.a.wrap((function(e) {
                        for (;;) switch (e.prev = e.next) {
                            case 0:
                                return c.storeData.sessionId = "", e.prev = 1, e.next = 4, n.userLogin(t);
                            case 4:
                                o = e.sent, c.storeData.userInfo = "", c.storeData.urls = "", o.phone && o.countryCode ? (o.userInfo.phone = o.phone, 0 !== o.countryCode && (o.userInfo.countryCode = "+" + o.countryCode)) : t.phone && t.countryCode && (o.userInfo.phone = t.phone, o.userInfo.countryCode = t.countryCode), o.loginName && (o.userInfo.loginName = o.loginName), c.storeData.isUser = 1, c.storeData.sessionId = o.sessionId, c.storeData.userInfo = o.userInfo, c.storeData.urls = o.urls, c.storeData.sysNoticeList = [], c.storeData.concernList = null, c.storeData.newMsg = 0, p(c.storeData.sessionId, c.storeData.userInfo, c.storeData.urls, c.storeData.isUser), e.next = 22;
                                break;
                            case 19:
                                return e.prev = 19, e.t0 = e.catch(1), e.abrupt("return", Promise.reject(e.t0));
                            case 22:
                            case "end":
                                return e.stop()
                        }
                ...
                return r()(i.a.mark((function n() {
                    return i.a.wrap((function(n) {
                        for (;;) switch (n.prev = n.next) {
                            case 0:
                                return n.prev = 0, n.next = 3, e.userRegister(t).then((function(e) {
                                    c.storeData.urls = "", c.storeData.sessionId = "", c.storeData.userInfo = "", e.userInfo.phone = t.phone, e.userInfo.countryCode = t.countryCode, e.userInfo.loginName = t.loginName, c.storeData.isUser = 1, c.storeData.sessionId = e.sessionId, c.storeData.userInfo = e.userInfo, c.storeData.urls = e.urls, c.storeData.sysNoticeList = [], c.storeData.concernList = null, c.storeData.newMsg = 0, p(c.storeData.sessionId, c.storeData.userInfo, c.storeData.urls, c.storeData.isUser)
                                }));
                            case 3:
                                n.next = 8;
                                break;
                            case 5:
                                return n.prev = 5, n.t0 = n.catch(0), n.abrupt("return", Promise.reject(n.t0));
                            case 8:
                            case "end":
                                return n.stop()
                        }
            ...
            handleUserLogout: function(t) {
                ...
                return r()(i.a.mark((function t() {
                    return i.a.wrap((function(t) {
                        for (;;) switch (t.prev = t.next) {
                            case 0:
                                return t.next = 2, e.userLogout();
                            case 2:
                                c.storeData.sessionId = "", c.storeData.userInfo = "", c.storeData.urls = "", c.storeData.isUser = 0, p(c.storeData.sessionId, c.storeData.userInfo, c.storeData.urls, c.storeData.isUser);
                            case 7:
                            case "end":
                                return t.stop()
                        }
            ...
            handleLoginJump: function(t) {
                return t ? (1 == c.storeData.isUser && this.handleGuestLogin(), this.handleShowLoginWindow(), !0) : !this.handleIsHadUserLogin() && (this.handleShowLoginWindow(), !0)
            },
            ...
            handleGuestLogin: function() {
                var t = (-(new Date).getTime()).toString() + parseInt(9e5 * Math.random() + 1e5, 10).toString(),
                    ...
                    n = Object.assign({}, e);
                c.storeData.userInfo = n, c.storeData.urls = "", c.storeData.sessionId = t, c.storeData.isUser = 0, c.storeData.sysNoticeList = [], c.storeData.concernList = null
            }
        }
    }, function(t, e, n) {
        "use strict";
        ...
        var o = n(46),
            ...
            s = new(function() {
                function t() {
                    r()(this, t), this.db = null, this.tb_chat = "chat", this.tb_friends = "friends", this.version = 3
                }
                return i()(t, [{
                    key: "protect",
                    value: function() {
                    ...
                    value: function() {
                        ...
                        return new Promise((function(e, n) {
                            ...
                            o.onsuccess = function() {
                                ...
                                r.db = t.target.result, 0 != t.oldVersion && t.oldVersion < r.version && (r.db.objectStoreNames.contains(r.tb_chat) && r.db.deleteObjectStore(r.tb_chat), r.db.objectStoreNames.contains(r.tb_friends) && r.db.deleteObjectStore(r.tb_friends));
                                var e = null;
                    ...
                    value: function(t, e, n, o) {
                        ...
                        return new Promise((function(a, i) {
                            r.protect().then((function() {
                                ...
                                s.onsuccess = function(t) {
                                    var e = t.target.result;
                                    e && (c.push(e.value), e.continue()), a(c)
                                }, s.onerror = function(t) {
                                    i(t)
                                }
                            }))
                        ...
                        return new Promise((function(a, i) {
                            r.protect().then((function() {
                                ...
                                c.onsuccess = function(t) {
                                    var e = t.target.result;
                                    e ? (u.push(e.value), e.continue()) : a(u)
        ...
        e.default = {
            ...
            mdTime: function(t) {
                if (t) {
                    var e = u(t),
                        ...
                        o = (n[0], n[1]),
                        i = n[2];
                    return n[3], n[4], n[5], "".concat(o).concat(a.default.month).concat(i).concat(a.default.day)
                }
            },
            hmTime: function(t) {
                if (t) {
            ...
            sysNoticeTime: function(t) {
                var e = u(t),
                    ...
                    m = p[3],
                    v = p[4];
                return p[5], o === h && i === f && s === g ? c === m ? v == l ? a.default.just : v - l + a.default.minute_ago : m - c + a.default.hour_ago : "".concat(i, "-").concat(s, " ").concat(c, ":").concat(l)
            },
            sysNoticeTime2: function(t) {
                var e = u(t),
                    ...
                    m = p[3],
                    v = p[4];
                return p[5], o === h && i === f && s === g ? c === m ? v == l ? a.default.just : v - l + a.default.minute_ago : m - c + a.default.hour_ago : "".concat(o, ".").concat(i, ".").concat(s, " ").concat(c, ":").concat(l)
            },
            matchTime: function(t) {
                if (t) {
                    var e = u(t),
                        ...
                        f = p[1],
                        g = p[2];
                    if (p[3], p[4], p[5], "".concat(o) == "".concat(h) && "".concat(i) == "".concat(f) && "".concat(s) == "".concat(g)) return "".concat(a.default.today, " ").concat(c, ":").concat(l);
            ...
            birthTime: function(t) {
                if (t) {
                    var e = u(t),
                        ...
                        a = n[1],
                        i = n[2];
                    return n[3], n[4], n[5], "".concat(o, "/").concat(a, "/").concat(i)
                }
            },
            ...
            parsePhone: function(t) {
                if (t && 0 !== t.length) {
                    for (var e = "", n = 0; n < t.length - 2 - 4; n++) e += "*";
        ...
        var o = n(3),
            ...
            i = 0,
            s = function(t, e) {
                if (t.message = t.message.trim(), t.message) {
                    t.className || (t.className = ""), t.duration || 0 == t.duration || (t.duration = 2e3), t.transition || (t.transition = 300), t.cssTransition = t.transition / 1e3, t.top || (t.position || (t.top = "80%"), "top" == t.position && (t.top = "20%"), "middle" == t.position && (t.top = "50%"), "bottom" == t.position && (t.top = "80%"));
                    ...
                    o.style.cssText = "\n    display: block;\n    position: fixed;\n    padding: 10px;\n    top: ".concat(t.top, ";\n    left: 50%;\n    transform: translateX(-50%);\n    border-radius: 5px;\n    background: rgba(0,0,0,.7);\n    color: #fff;\n    font-size: 14px;\n    box-sizing: border-box;\n    text-align: center;\n    transition: opacity ").concat(t.cssTransition, "s linear;\n    opacity: 0;\n    z-index: 9999;\n    "), setTimeout((function() {
                        o.style.opacity = 1, 0 != t.duration && setTimeout((function() {
                            o.style.opacity = 0, setTimeout((function() {
                                document.body.removeChild(o), e && e()
                            }), t.transition + 1)
            ...
            c = function(t, e) {
                if (null != document.querySelector(".com-actionsheet.".concat(t))) return document.querySelector(".com-actionsheet.".concat(t)).style.transform = "translateY(0%)", document.querySelector(".com-actionsheet-modal").style.width = "100%", void(document.querySelector(".com-actionsheet-modal").style.height = "100%");
                if (e.actions && 0 != e.actions.length) {
                    e.cancelText || (e.cancelText = "取消"), null == e.closeOnClickModal && (e.closeOnClickModal = !0);
                    ...
                    n = "", e.actions.map((function(t) {
                        n += '<li class="com-actionsheet-item" data-value='.concat(t.value, ">").concat(t.name, "</li>")
                    })), r.innerHTML = n, o.style.cssText = "\n  position: fixed;\n      width: 100%;\n      text-align: center;\n      font-size: 18px;\n      left: 0;\n      bottom: 0;\n      z-index: 9999;\n      transition: transform .3s ease-out;\n      transform: translateY(100%);\n  ", r.style.cssText = "\n  list-style: none;\n  padding: 0;\n  margin: 0;\n  margin-bottom: 5px;\n  ", a.style.cssText = "\n  width: 100%;\n  height: 45px;\n  line-height: 45px;\n  background: #fff;;\n  ";
                    for (var s = function(t) {
                            i[t].style.cssText = "\n  height: 45px;\n  line-height: 45px;\n  border-bottom: 1px solid #e0e0e0;\n  background-color: #fff;\n  ", i[t].onclick = function() {
                                e.actions[t].method(e.actions[t].value), o.style.transform = "translateY(100%)", setTimeout((function() {
                                    document.querySelector(".com-actionsheet-modal").style.width = 0, document.querySelector(".com-actionsheet-modal").style.height = 0
                                }), 300)
                            }
                        }, c = 0; c < i.length; c++) s(c);
                    i[i.length - 1].style.border = "none", setTimeout((function() {
                    ...
                    if (!u) {
                        ...
                        document.body.insertAdjacentHTML("beforeend", '<div class="com-actionsheet-modal"></div>'), (u = document.querySelector(".com-actionsheet-modal")).style.cssText = "\n      position: fixed;\n      left: 0;\n      top: 0;\n      opacity: 0.5;\n      background: #000;\n      z-index: 9998;\n      ", e.closeOnClickModal && (u.onclick = function() {
                            l.style.transform = "translateY(100%)", setTimeout((function() {
                                u.style.width = 0, u.style.height = 0
                            }), 300)
                        })
                    }
            ...
            u = function(t, e) {
                if (t.message = t.message.trim(), t.message) {
                    t.container || (t.container = ".header-wrapper"), t.position || (t.position = "beforeend"), t.className || (t.className = ""), t.cssText || (t.cssText = ""), t.duration || 0 == t.duration || (t.duration = 2e3), t.transition || (t.transition = 300), t.cssTransition = t.transition / 1e3;
                    ...
                    setTimeout((function() {
                        i.style.opacity = 1, 0 != t.duration && setTimeout((function() {
                            i.style.opacity = 0, setTimeout((function() {
                                "beforebegin" != t.position && "afterend" != t.position || r.parentNode.removeChild(i), "afterbegin" != t.position && "beforeend" != t.position || r.removeChild(i), e && e()
                            }), t.transition + 1)
                        }), t.duration - 2 * t.transition)
                    }), 1), a++
                }
            ...
            l = function(t, e) {
                if (t.message) {
                    t.duration || 0 == t.duration || (t.duration = 2200), t.transition || (t.transition = 150), t.cssTransition = t.transition / 1e3;
                    ...
                    r.style.cssText = "\n  position: fixed;\n  top: 0;\n  left: 50%;\n  transform: translate(-50%, -60px);\n  display: block;\n  min-width: 150px;\n  height: 60px;\n  padding: 0px 35px;\n  line-height: 58px;\n  text-align: center;\n  font-size: 0;\n  font-weight: 500;\n  background: #fffdf5;\n  border-radius: 8px;\n  border: 2px solid #ebeef5;\n  transition: transform ".concat(t.cssTransition, "s linear;\n  z-index: 9999;\n  "), r.querySelector("span").style.cssText = "color: #333; font-size: 16px; vertical-align: middle;", setTimeout((function() {
                        r.style.transform = "translate(-50%, 60px)", 0 != t.duration && setTimeout((function() {
                            r.style.transform = "translate(-50%, -60px)", setTimeout((function() {
                                o.removeChild(r), e && e()
                            }), t.transition + 1)
                        }), t.duration - 2 * t.transition)
                    }), 12), i++
        ...
        c.a.defaults.withCredentials = !0, c.a.interceptors.request.use((function(t) {
            return t
        }), (function(t) {
        ...
        var T = function() {
                var t = r()(i.a.mark((function t(e) {
                    ...
                    return i.a.wrap((function(t) {
                        for (;;) switch (t.prev = t.next) {
                            case 0:
                                if (n = f.length > 1 && void 0 !== f[1] ? f[1] : {}, o = f.length > 2 ? f[2] : void 0, !u.storeData.sessionId && "/login/guestLogin" !== e) try {
                                ...
                                return a = {
                                    ...
                                    plat: 3,
                                    language: 1
                                }, s = p.default.initByte(a, "".concat(JSON.stringify(n)), d.default.API_KEY_REQ), t.abrupt("return", c()({
                                    method: "post",
                                    baseURL: _,
                                    url: e,
                                    responseType: "blob",
                                    ...
                                    var t = r()(i.a.mark((function t(n) {
                                        ...
                                        return i.a.wrap((function(t) {
                                            for (;;) switch (t.prev = t.next) {
                                                case 0:
                                                    return t.next = 2, p.default.initJson(n, d.default.API_KEY_RESP);
                                                case 2:
                                                ...
                                                case 7:
                                                    ...
                                                    o ? console.log("需要用户重登，但不跳转登录页面") : (console.log("需要用户重登，跳转登录页面"), l.default.handleLoginJump(!0)), t.next = 23;
                                                    break;
                                                case 11:
                                                ...
                                                case 20:
                                                    ...
                                                    }), console.log(r.commonResult.meg || "接口报错", e, r), t.abrupt("return", Promise.reject(r.commonResult));
                                                case 23:
                                                case "end":
                                                    return t.stop()
                                            }
                    ...
                    return i.a.wrap((function(t) {
                        for (;;) switch (t.prev = t.next) {
                            case 0:
                                ...
                                }, e || reject("jsonp: url is null"), n || reject("jsonp: callback is null"), r = null, a = null, t.abrupt("return", new Promise((function(t, i) {
                                    r = t, a = i, o ? setTimeout((function() {
                                        c(e, n, 0)
                                    }), o) : c(e, n, 0)
                                })));
                            case 7:
            ...
            M = function() {
                var t = r()(i.a.mark((function t(e) {
                    ...
                    return i.a.wrap((function(t) {
                        for (;;) switch (t.prev = t.next) {
                            case 0:
                                return n = u.length > 1 && void 0 !== u[1] ? u[1] : {}, o = f.default.uuid().replace(/-/g, ""), a = (new Date).getTime(), s = {
                                        ...
                                        return i.a.wrap((function(t) {
                                            for (;;) switch (t.prev = t.next) {
                                                ...
                                                case 4:
                                                    ...
                                                    }), console.log(o.msg || "接口报错", e, n), t.abrupt("return", Promise.reject(o));
                                                case 7:
                                                case "end":
                                                    return t.stop()
                                            }
        ...
        n(0), e.default = {
            ...
            countryCodePhone: function(t, e) {
                if ("+86" == t) {
                    ...
                    if (/^[35789][0-9]{8}$/.test(e)) return !0
                } else if (e.length >= 5) return !0;
                return !1
            },
        ...
        var o, r = n(10),
            ...
            C = {
                ...
                init: function() {
                    if (console.log("ws 初始化"), m = this, !v || 0 !== v.readyState && 1 !== v.readyState || (console.log("由于ws已存在，主动断开 ws，不进行重连", v.readyState), m.reset(!0)), "WebSocket" in window || "MozWebSocket" in window) {
                        _++;
                        var t = "".concat(g, "/?sid=").concat(_);
                        return b = t, (v = new WebSocket(t)).onopen = m.onopen, v.onmessage = m.onmessage, v.onclose = m.onclose, v.onerror = m.onerror, w && (w = !1, h.default.closePageListener((function() {
                            v && (m.logout(), m.reset(!0))
                        }))), v
                    }
                    Object(p.Msg)({
                ...
                onopen: function() {
                    console.log("ws 连接成功"), $(".reconnect-tip").hide(), m.send(u.default.WS_CODE.LOGIN, m.sessionInfo), o = setInterval((function() {
                        console.log("心跳"), m.send(u.default.WS_CODE.HEART)
                    }), 1e4)
                },
                ...
                onclose: function(t) {
                    console.log("ws 关闭: " + t.code + ",关闭原因：" + t.reason + "，是否为完全关闭：" + t.wasClean + "，是否为主动关闭：", T), 1006 !== t.code || t.wasClean || T || (m.clearTimer(), m.reconnection()), T && (T = !1)
                },
                onerror: function(t) {
                    console.log("ws 错误", t), b === t.target.url || console.log("onerror: wsUrl不一样")
                },
                reconnection: function() {
                    console.log("ws 重连中......"), $(".reconnect-tip").show(), setTimeout((function() {
                        console.log("ws 进行重连"), m.init()
                    }), 2e3)
                },
                reset: function(t) {
                    this.clearTimer(), !v || 0 !== v.readyState && 1 !== v.readyState || (T = t, v.close(), v = null)
                },
                clearTimer: function() {
                    o && (clearInterval(o), o = null), y && (clearTimeout(y), y = null)
                },
                isActive: function() {
                    if (!($(".liveRoom-wrapper").length > 0)) return !0
                },
                send: function(t, e) {
                    if (!window.WebSocket || !v) return console.log("没有ws"), !1;
                    if (v.readyState != WebSocket.OPEN) return console.log("ws 准备发送消息，但 ws 没有 open"), void Object(p.Msg)({
                        message: f.default.reconnect_tip,
                        duration: 2e3
                    });
                    var n, o, r = 0;
                    e && (n = l.default.stringToUint8Array(JSON.stringify(e)), r = (o = l.default.getAesString(n, u.default.API_KEY_REQ)).length);
                    var a = new ArrayBuffer(8 + r),
                        i = new DataView(a);
                    i.setInt8(0, 0, !1), i.setInt8(1, -96, !1), i.setUint16(2, t, !1), i.setUint32(4, r, !1);
                    for (var s = 0; s < r; s++) i.setUint8(s + 8, o[s]);
                    v.send(a)
                },
                receive: function(t) {
                    if (t && (t instanceof ArrayBuffer || t instanceof Blob)) return new Promise(function() {
                        var e = a()(s.a.mark((function e(n, o) {
                            var r, a, i, c, d;
                            return s.a.wrap((function(e) {
                                for (;;) switch (e.prev = e.next) {
                                    case 0:
                                        return r = new FileReader, a = t, i = "", c = "", d = "", r.readAsArrayBuffer(a), e.next = 9,
                                            function(t) {
                                                var e, o = r.result,
                                                    a = new DataView(o);
                                                i = a.getUint16(2), a.getUint32(4), c = o.slice(8), 2e3 !== i ? (e = l.default.getDAesString(new Uint8Array(c), u.default.API_KEY_RESP), d = JSON.parse(l.default.uint8ArrayToString(e))) : d = {}, n({
                                                    messageId: i,
                                                    message: d
                                                })
                                            };
        ...
        r.a.enc.u8array = {
            ...
            parse: function(t) {
                for (var e = t.length, n = [], o = 0; o < e; o++) n[o >>> 2] |= (255 & t[o]) << 24 - o % 4 * 8;
        ...
        e.default = {
            initByte: function(t, e, n) {
                ...
                a.setSessionId(t.sessionId), a.setSeq(t.seq), a.setAppVer(t.appVer), a.setPackageCode(t.packageCode), a.setPlat(t.plat), a.setLanguage(t.language), r.setClientInfo(a), r.setParam(s(e)), o.setCommonReq(r);
                var c = u(o.serializeBinary(), n),
                    l = c.length,
                    d = new ArrayBuffer(6 + l),
                    p = new DataView(d);
                p.setInt8(0, 0, !1), p.setInt8(1, -96, !1), p.setUint32(2, l, !1);
                for (var h = 0; h < l; h++) p.setUint8(h + 6, c[h]);
                return d
            },
            initJson: function(t, e) {
                return new Promise((function(n) {
                    ...
                    var o = new FileReader,
                        r = t.slice(6);
                    o.readAsArrayBuffer(r), o.onload = function(t) {
        ...
        r.exportSymbol("proto.http.CLIENT_INFO", null, a), r.exportSymbol("proto.http.COMMON_REQ", null, a), r.exportSymbol("proto.http.COMMON_RESP", null, a), r.exportSymbol("proto.http.COMMON_RESULT", null, a), r.exportSymbol("proto.http.FY_CLIENT", null, a), proto.http.FY_CLIENT = function(t) {
            o.Message.initialize(this, t, 0, -1, null, null)
        }, r.inherits(proto.http.FY_CLIENT, o.Message), r.DEBUG && !COMPILED && (proto.http.FY_CLIENT.displayName = "proto.http.FY_CLIENT"), o.Message.GENERATE_TO_OBJECT && (proto.http.FY_CLIENT.prototype.toObject = function(t) {
            ...
            for (; e.nextField() && !e.isEndGroup();) switch (e.getFieldNumber()) {
                case 1:
                    ...
                    e.readMessage(n, proto.http.COMMON_REQ.deserializeBinaryFromReader), t.setCommonReq(n);
                    break;
                case 2:
                    n = new proto.http.COMMON_RESP, e.readMessage(n, proto.http.COMMON_RESP.deserializeBinaryFromReader), t.setCommonResp(n);
                    break;
                default:
                    e.skipField()
            }
            ...
            return proto.http.FY_CLIENT.serializeBinaryToWriter(this, t), t.getResultBuffer()
        }, proto.http.FY_CLIENT.serializeBinaryToWriter = function(t, e) {
            var n = void 0;
            null != (n = t.getCommonReq()) && e.writeMessage(1, n, proto.http.COMMON_REQ.serializeBinaryToWriter), null != (n = t.getCommonResp()) && e.writeMessage(2, n, proto.http.COMMON_RESP.serializeBinaryToWriter)
            ...
            o.Message.initialize(this, t, 0, -1, null, null)
        }, r.inherits(proto.http.CLIENT_INFO, o.Message), r.DEBUG && !COMPILED && (proto.http.CLIENT_INFO.displayName = "proto.http.CLIENT_INFO"), o.Message.GENERATE_TO_OBJECT && (proto.http.CLIENT_INFO.prototype.toObject = function(t) {
            ...
            for (; e.nextField() && !e.isEndGroup();) switch (e.getFieldNumber()) {
                case 1:
                    ...
                    break;
                case 2:
                    n = e.readInt32(), t.setSeq(n);
                    break;
                case 3:
                    n = e.readInt32(), t.setAppVer(n);
                    break;
                case 4:
                    n = e.readInt32(), t.setPackageCode(n);
                    break;
                case 5:
                    n = e.readInt32(), t.setPlat(n);
                    break;
                case 6:
                    n = e.readInt32(), t.setLanguage(n);
                    break;
                default:
                    e.skipField()
            }
            ...
            var t = new o.BinaryWriter;
            return proto.http.CLIENT_INFO.serializeBinaryToWriter(this, t), t.getResultBuffer()
        }, proto.http.CLIENT_INFO.serializeBinaryToWriter = function(t, e) {
            var n = void 0;
            (n = t.getSessionId()).length > 0 && e.writeString(1, n), 0 !== (n = t.getSeq()) && e.writeInt32(2, n), 0 !== (n = t.getAppVer()) && e.writeInt32(3, n), 0 !== (n = t.getPackageCode()) && e.writeInt32(4, n), 0 !== (n = t.getPlat()) && e.writeInt32(5, n), 0 !== (n = t.getLanguage()) && e.writeInt32(6, n)
            ...
            o.Message.initialize(this, t, 0, -1, null, null)
        }, r.inherits(proto.http.COMMON_RESULT, o.Message), r.DEBUG && !COMPILED && (proto.http.COMMON_RESULT.displayName = "proto.http.COMMON_RESULT"), o.Message.GENERATE_TO_OBJECT && (proto.http.COMMON_RESULT.prototype.toObject = function(t) {
            ...
            for (; e.nextField() && !e.isEndGroup();) switch (e.getFieldNumber()) {
                case 1:
                    ...
                    break;
                case 2:
                    n = e.readString(), t.setErrMsg(n);
                    break;
                case 3:
                    n = e.readInt32(), t.setSeq(n);
                    break;
                case 4:
                    n = e.readString(), t.setNewSessionId(n);
                    break;
                default:
                    e.skipField()
            }
            ...
            var t = new o.BinaryWriter;
            return proto.http.COMMON_RESULT.serializeBinaryToWriter(this, t), t.getResultBuffer()
        }, proto.http.COMMON_RESULT.serializeBinaryToWriter = function(t, e) {
            var n = void 0;
            0 !== (n = t.getErrCode()) && e.writeInt32(1, n), (n = t.getErrMsg()).length > 0 && e.writeString(2, n), 0 !== (n = t.getSeq()) && e.writeInt32(3, n), (n = t.getNewSessionId()).length > 0 && e.writeString(4, n)
            ...
            o.Message.initialize(this, t, 0, -1, null, null)
        }, r.inherits(proto.http.COMMON_REQ, o.Message), r.DEBUG && !COMPILED && (proto.http.COMMON_REQ.displayName = "proto.http.COMMON_REQ"), o.Message.GENERATE_TO_OBJECT && (proto.http.COMMON_REQ.prototype.toObject = function(t) {
            ...
            for (; e.nextField() && !e.isEndGroup();) switch (e.getFieldNumber()) {
                case 1:
                    ...
                    e.readMessage(n, proto.http.CLIENT_INFO.deserializeBinaryFromReader), t.setClientInfo(n);
                    break;
                case 2:
                    n = e.readBytes(), t.setParam(n);
                    break;
                default:
                    e.skipField()
            }
            ...
            var t = new o.BinaryWriter;
            return proto.http.COMMON_REQ.serializeBinaryToWriter(this, t), t.getResultBuffer()
        }, proto.http.COMMON_REQ.serializeBinaryToWriter = function(t, e) {
            var n = void 0;
            null != (n = t.getClientInfo()) && e.writeMessage(1, n, proto.http.CLIENT_INFO.serializeBinaryToWriter), (n = t.getParam_asU8()).length > 0 && e.writeBytes(2, n)
            ...
            o.Message.initialize(this, t, 0, -1, null, null)
        }, r.inherits(proto.http.COMMON_RESP, o.Message), r.DEBUG && !COMPILED && (proto.http.COMMON_RESP.displayName = "proto.http.COMMON_RESP"), o.Message.GENERATE_TO_OBJECT && (proto.http.COMMON_RESP.prototype.toObject = function(t) {
            ...
            for (; e.nextField() && !e.isEndGroup();) switch (e.getFieldNumber()) {
                case 1:
                    ...
                    e.readMessage(n, proto.http.COMMON_RESULT.deserializeBinaryFromReader), t.setCommonResult(n);
                    break;
                case 2:
                    n = e.readBytes(), t.setResult(n);
                    break;
                default:
                    e.skipField()
            }
            ...
            var t = new o.BinaryWriter;
            return proto.http.COMMON_RESP.serializeBinaryToWriter(this, t), t.getResultBuffer()
        }, proto.http.COMMON_RESP.serializeBinaryToWriter = function(t, e) {
            var n = void 0;
            null != (n = t.getCommonResult()) && e.writeMessage(1, n, proto.http.COMMON_RESULT.serializeBinaryToWriter), (n = t.getResult_asU8()).length > 0 && e.writeBytes(2, n)
        ...
        n.r(e), e.default = {
            cursorEnd: function(t) {
                if (window.getSelection) t.focus(), (e = window.getSelection()).selectAllChildren(t), e.collapseToEnd();
                else if (document.selection) {
                    var e;
                    (e = document.selection.createRange()).moveToElementText(t), e.collapse(!1), e.select()
                }
            },
            onlyPasteText: function(t) {
                t.addEventListener("paste", (function(t) {
                    t.preventDefault();
                    var e;
                    if (e = window.clipboardData && clipboardData.setData ? window.clipboardData.getData("text") : (t.originalEvent || t).clipboardData.getData("text/plain"), document.body.createTextRange) {
                        if (document.selection) textRange = document.selection.createRange();
                        else if (window.getSelection) {
                            sel = window.getSelection();
                            var n = sel.getRangeAt(0),
                                o = document.createElement("span");
                            o.innerHTML = "&#FEFF;", n.deleteContents(), n.insertNode(o), textRange = document.body.createTextRange(), textRange.moveToElementText(o), o.parentNode.removeChild(o)
                        }
        ...
        var o = n(46),
            ...
            s = function() {
                function t(e) {
                    for (var n in r()(this, t), this.$data = "Object" === this.getBaseType(e.data) ? e.data : {}, this.$watch = "Object" === this.getBaseType(e.watch) ? e.watch : {}, e.data) this.setData(n)
                }
                return i()(t, [{
                    key: "getBaseType",
                    value: function(t) {
                    ...
                    value: function(t) {
                        Object.defineProperty(this, t, {
                            ...
                            set: function(e) {
                                var n = this.$data[t];
                                return n === e || (this.$data[t] = e, this.$watch[t] && "function" == typeof this.$watch[t] && this.$watch[t].call(this, e, n)), e
                            }
                        })
                    }
                }]), t
        ...
        "use strict";
        n.r(e), n.d(e, "wsHandler", (function() {
            return l
        }));
        var o = n(0),
            r = n(1),
                ...
                resolve: function(t, e) {
                    ...
                    switch (t) {
                        ...
                        case n.ROOM_ENTER_SUCCESS:
                            r.storeData.wsLastestComment && r.storeData.wsLastestComment.flag && 0 == $(".liveRoom-wrapper .chat-list .chat-item[data-flag=".concat(r.storeData.wsLastestComment.flag, "]")).length && (a.default.send(o.default.WS_CODE.COMMENT, r.storeData.wsLastestComment), r.storeData.wsLastestComment = null);
                            break;
                        ...
                        case n.COMMENT_PUSH:
                            if ("1" == o.default.showComment) {
                                if (2 === e.msgType && r.storeData.userInfo && e.sendUid === r.storeData.userInfo.uid) return;
                                if (3 !== e.msgType || !r.storeData.shieldWc && 3 === e.msgType) {
                                    var d = [];
                                    d.concat(r.storeData.commentList), d.push(e), r.storeData.commentList = d
                                }
                        ...
                        case n.SCORE_GROW_PUSH:
                            ...
                            p.grow = p.grow + e.grow, p.score = p.score + e.score, p.grow >= p.growDto.nextMinGrom && (p.grow = p.grow - p.growDto.nextMinGrom, r.storeData.levelUpShow = !0), r.storeData.userInfo = Object.assign({}, p), r.storeData.growScoreUp = Object.assign({}, e);
                            break;
                        ...
                        case n.SUBSCRIBE_MATCH_LIST_PUSH:
                            ...
                            break;
                        case n.ERROR:
                            if (console.log("ws error, errCode:" + e.errCode + ", errMsg:" + e.errMsg), 1e3 === e.errCode) a.default.send(o.default.WS_CODE.ROOM_ENTER, {
                                roomNum: r.storeData.roomNum
                            });
                            else if (1002 == e.errCode && "请勿发布敏感内容，多次违规将封号处理" === e.errMsg) {
                                var h = $("#fullScreenTips");
                                h.length > 0 && (h.fadeIn(150), setTimeout((function() {
                                    h.fadeOut(150)
                                }), 3e3))
                            }
                            Object(i.Msg)({
