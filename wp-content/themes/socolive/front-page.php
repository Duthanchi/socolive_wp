        ...
        <div class="form"><input type="password" autocomplete="new-password" hidden="">
          ...
          <div class="account-box">
            <div class="input-group"><img class="icon"
                src="./Socolive - Trực tiếp bóng đá tốc độ cao không quảng cáo Full HD_files/user.svg"> <input
          ...
          <div class="remeber-box"><img class="gou"
              src="./Socolive - Trực tiếp bóng đá tốc độ cao không quảng cáo Full HD_files/gou.png"> <span
        ...
        <div class="form"><input type="password" autocomplete="new-password" hidden="">
          ...
          <div class="check-box" hidden="">
            <div class="input-group"><img class="icon"
                ...
                maxlength="5"> <img class="check-img" src="https://socolive10.tv/"></div>
