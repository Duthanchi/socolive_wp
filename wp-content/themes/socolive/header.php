      ...
      <div class="header-right">
        ...
        <div class="had-login" style="display:none">
            ...
            <div class="submenu concern-submenu" hidden="">
              <div class="submenu-box">
                <div class="concern-none"><img
                    src="./Socolive - Trực tiếp bóng đá tốc độ cao không quảng cáo Full HD_files/none.png"> <span
          ...
          <div class="header-avatar"><img class="special-avatar avatar"
              src="./Socolive - Trực tiếp bóng đá tốc độ cao không quảng cáo Full HD_files/avatar.png">
              ...
              <div class="submenu-box">
                <div class="top float-clear">
                  <div class="top-up float-clear"><img class="avatar"
                      src="./Socolive - Trực tiếp bóng đá tốc độ cao không quảng cáo Full HD_files/avatar.png"> <span
          ...
          <div class="submenu submenu-box grow-score-up-submenu float-clear" hidden=""><img
              src="./Socolive - Trực tiếp bóng đá tốc độ cao không quảng cáo Full HD_files/grow-score.png"> <span
